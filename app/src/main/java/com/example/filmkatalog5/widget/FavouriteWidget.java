...
public class FavouriteWidget extends AppWidgetProvider {
    public static final String TOAST_ACTION = "com.example.filmkatalog5.TOAST_ACTION";
    public static final String EXTRA_ITEM = "com.example.filmkatalog5.EXTRA_ITEM";
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (Objects.requireNonNull(intent.getAction()).equals(UPDATE_WIDGET)) {
            int[] widgetId = manager.getAppWidgetIds(new ComponentName(context, FavouriteWidget.class));
